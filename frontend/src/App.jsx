...
const App = () => {
  ...
  // We use a functional state update (prev => [...prev, newTrip]) to remove myTrips from the dependency array,
  // ensuring the callback reference remains completely stable across renders and BookingModal correctly memoizes.
