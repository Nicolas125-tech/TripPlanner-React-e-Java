...
const App = () => {
  ...
  // Added functional state update for setMyTrips to avoid recreating the callback when myTrips changes,
  // keeping the reference perfectly stable across bookings and preventing BookingModal from re-rendering.
