...
public class DataSeeder {
    ...
    @Bean
    public CommandLineRunner seedDatabase(final TripRepository tripRepository) {
        return args -> {
            if (tripRepository.count() == 0) {
                ...
                // Replaced individual tripRepository.save() calls with saveAll() to optimize inserts.
                // This reduces database round-trips and leverages JPA batching.
                tripRepository.saveAll(List.of(trip1, trip2, trip3, trip4, trip5));
            }
        };
    }
}
