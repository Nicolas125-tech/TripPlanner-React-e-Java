...
public class TripService {
    ...
    // This provides a measurable performance boost by disabling Hibernate's dirty checking mechanism.
    // Since these methods only fetch data and do not modify it, bypassing the dirty checking
    // saves significant CPU cycles and memory overhead, especially for operations returning lists.
